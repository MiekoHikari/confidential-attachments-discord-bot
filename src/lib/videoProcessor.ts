...
/**
 * Create a watermark overlay buffer using canvas
 */
...
/**
 * Watermark an image and return the processed buffer
 */
export async function watermarkImage(imageUrl: string, watermark: string): Promise<Buffer> {
